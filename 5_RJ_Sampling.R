...
#-----------------------------------------------------
# Understand samples' property -- Independent samples
#-----------------------------------------------------
str(outputs$samples)
# num [1:48]

plot(1:48, outputs$samples, xlab = "Iterations", 
     ylab = "Accepted independent samples")
## Remark:
  # the accepted samples generated by RJ sampling 
  # is completely independent 
  # there's no correlation between sample at iteration n
      # and the sample at iteration n+1
#------------------------------------------------------
